...
rects11 = ax.bar(x - 1.5 * width, values[0,:], width * 1.2, label='#BP=3',color='#9b9ca0', zorder = 2)
rects12 = ax.bar(x              , values[1,:], width * 1.2, label='#BP=5',color='#935859', zorder = 2)
rects13 = ax.bar(x + 1.5 * width, values[2,:], width * 1.2, label='#BP=7',color='#64666a', zorder = 2)
