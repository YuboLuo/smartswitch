...
rects11 = ax.bar(x - 1.5 * width, values[0,:], width * 1.2, label='#Min-budget',color='#5d89a8', zorder = 2)
rects12 = ax.bar(x              , values[1,:], width * 1.2, label='#Tradeoff-budget',color='#64666a', zorder = 2)
rects13 = ax.bar(x + 1.5 * width, values[2,:], width * 1.2, label='#Max-budget',color='#935859', zorder = 2)
...
fig.show()
fig.savefig("BPlocation_variety.pdf")
