...
rects15 = ax.bar(x + 2 * width, values[4,:], width*0.8, label='SS',color='#8c0000', edgecolor='#353337', zorder = 2) # #bbd6e8

# rects11 = ax.bar(x - 2 * width, values[0,:], width, label='NWV',color='#1F77B4')
# rects12 = ax.bar(x - 1 * width, values[1,:], width, label='NVS',color='#735184')
# rects13 = ax.bar(x            , values[2,:], width, label='YONO',color='#629fca')
# rects14 = ax.bar(x + 1 * width, values[3,:], width, label='Vanilla',color='#ffa352')
# rects15 = ax.bar(x + 2 * width, values[4,:], width, label='SmartSwitch',color='#3F5A8A')
