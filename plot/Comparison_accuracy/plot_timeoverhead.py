...
rects15 = ax.bar(x + 1.5 * width, values[4,:], width*0.8, label='MTL',color='#3F5A8A', edgecolor='#353337', zorder = 2) # #bbd6e8
rects16 = ax.bar(x + 2.5 * width, values[5,:], width*0.8, label='SS',color='#8c0000', edgecolor='#353337', zorder = 2) # #bbd6e8
