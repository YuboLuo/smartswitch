...
rects14 = ax.bar(x - 1 * width, values[3,:], width*0.8, label='Vanilla',color='#ffa352', edgecolor='#353337', zorder = 2)
rects15 = ax.bar(x  , values[4,:], width*0.8, label='MTL',color='#3F5A8A', edgecolor='#353337', zorder = 2)
rects16 = ax.bar(x + 1 * width, values[4,:], width*0.8, label='SS',color='#8c0000', edgecolor='#353337', zorder = 2)
